...
| `decisions/` | 設計判断の記録 (ADR) | 0001-reservation-create-concurrency.md, 0002-reservation-update-cancel-list.md, 0003-gate-down-idempotency.md, 0004-monorepo-core-extraction.md, 0005-telemetry-ingestion.md, 0006-iot-device-command-port.md, 0007-lifecycle-timer-sweep.md |
